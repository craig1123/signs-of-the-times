    ...
    return (
      <Fragment>
        ...
        <section className="home-section">
          ...
          <h2>When will these events take place?</h2>
          <hr />
          <p>No mans knows the hour or day when the Lord will come (<a href="https://www.lds.org/scriptures/pgp/js-m/1.40?lang=eng#39">Joseph Smith - Matthew 1:40</a>).</p>
          <hr />
